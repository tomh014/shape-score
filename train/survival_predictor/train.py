...
data_dir = 'model/project/'+project+'/'+prefix+'/data/train'
...
torch.save(model.state_dict(), os.path.join('model/model/'+'.'.join([prefix,project,classifier_type,'pth'])))
